...
555   continue
 ...
 subroutine p3_main_part3(kts, kte, kbot, ktop, kdir, &
      ...
      diag_eff_radius_qc, diag_eff_radius_qr, diag_ze_rain,diag_ze_ice)
  ...
  SUBROUTINE p3_main(qc,nc,qr,nr,th_atm,qv,dt,qi,qm,ni,bm,   &
       ...
       ,diag_equiv_reflectivity,diag_ze_rain,diag_ze_ice & !HYMA RADAR reflectivity
#ifdef SCREAM_CONFIG_IS_CMAKE
       ,elapsed_s &
#endif
      )
...
!      endif
       ...
       call p3_main_part3(kts, kte, kbot, ktop, kdir, &
            ...
            diag_equiv_reflectivity(i,:), diag_eff_radius_qc(i,:), diag_eff_radius_qr(i,:), diag_ze_rain(i,:),diag_ze_ice(i,:))
