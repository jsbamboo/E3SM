...
#if (defined MODAL_AERO_9MODE || defined MODAL_AERO_4MODE_MOM || defined MODAL_AERO_4MODE_BRC || defined MODAL_AERO_5MODE)
...
!-----------------------------------------------------------------------
    ...
    ! E90 tropopause
    call addfld('TROPL_E90U',          horiz_only,    'A',  'Level', 'Upper Tropopause level (E90)')
    call addfld('TROPL_E90B',          horiz_only,    'A',  'Level', 'Bottom Tropopause level (E90)')
    call addfld('TROPP_E90B',          horiz_only,    'A',  'Pa', 'Bottom Tropopause pressure (E90)')
    !-------------------------------
...
!-----------------------------------------------------------------------
    ...
    if (e90_ndx <= 0) then
      ...
      call tropopause_e90_3d(state, tmp_tropLev, tropLev, tropFlag, tropFlagInt,tropP=tropP)
      ! output troppause generated by E90
      call outfld('TROPL_E90U', tropLev*1.0_r8, pcols, lchnk ) ! upper tropopause
      call outfld('TROPL_E90B', tmp_tropLev*1.0_r8, pcols, lchnk ) ! bottom tropopause
      call outfld('TROPP_E90B', tropP, pcols, lchnk ) ! bottom tropopause
