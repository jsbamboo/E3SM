...
struct Functions
{
  ...
  struct P3HistoryOnly {
    ...
    view_2d<Spack> qmr2qr_melt;
    view_2d<Spack> qmr2qv_sublim;
  ...
  static void update_prognostic_ice(
    ...
    const Spack& nr_ice_shed_tend, const Spack& qi2qr_melt_tend, Spack& qmr2qr_melt_tend, Spack& qmr2qv_sublim_tend,  const Spack& ni2nr_melt_tend,  const Spack& qi2qv_sublim_tend,
  ...
  static void p3_main_part2(
    ...
    const uview_1d<Spack>& qmr2qr_melt,
    const uview_1d<Spack>& qmr2qv_sublim,
